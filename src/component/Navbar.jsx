...
export default function Navbar() {
  ...
  return (
    <div className={styles.nav}>
      <Box bg="white.500" w="full" p={4} color="white">
        <Flex
          h={16}
          w={"80%"}
          margin={"auto"}
            ...
            <Flex alignItems={"center"}>
              <Stack direction={"row"} spacing={7}>
                <Button borderRadius={"17px"} color={"black"} bg={"white"}>
                  <FiEdit2 /> <Text ml={"10px"}> Review</Text>
                </Button>
                <Button borderRadius={"17px"} color={"black"} bg={"white"}>
                  {" "}
                  <FiHeart /> <Text ml={"10px"}> Trips</Text>
                </Button>
                <Button borderRadius={"17px"} color={"black"} bg={"white"}>
                  <FiBell />
                  <Text ml={"10px"}> Alerts</Text>
                </Button>
                <Button
                  borderRadius={"17px"}
                  color={"black"}
